...
# calculate EAR as per the research paper
...
# Important variables to tune the implementation
EYE_AR_THRESH = 0.3
...
while True:
    ...
    # Loop over each of the faces in the frame and then apply facial landmark detection to each of them
    for rect in rects:
